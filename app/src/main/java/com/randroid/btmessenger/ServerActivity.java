...
import com.randroid.btmessenger.bluetooth.BluetoothServerService;
...
public class ServerActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(message.length() == 0){
                    Toast toast = Toast.makeText(ServerActivity.this.getApplicationContext(), "Message can not be empty.", Toast.LENGTH_SHORT);
                    toast.show();
                }
    ...
    private void registerReceiver(){
        Intent startServiceService = new Intent(ServerActivity.this, BluetoothServerService.class);
        ...
        intentFilter.addAction(BluetoothUtilities.ACTION_LISTENING_SUCCESS);
    ...
    private BroadcastReceiver serverServiceBroadReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothUtilities.ACTION_DATA_AVAILABLE.equals(action)) {
                ...
                String msg = "☑️ " + new Date().toLocaleString()
                        + " :\r\n" + BluetoothUtilities.space + "A Client connected to server successfully.\r\n";
                txtMessageHistory.append(msg);
                btnSend.setEnabled(true);
            }else if(BluetoothUtilities.ACTION_CONNECT_ERROR.equals(action)){
                String msg = "☑️ " + new Date().toLocaleString()
                        + " :\r\n" + BluetoothUtilities.space + "A Client connected to server failed.\r\n";
                txtMessageHistory.append(msg);
                btnSend.setEnabled(false);
            }
            else if(BluetoothUtilities.ACTION_LISTENING_SUCCESS.equals(action)){
                String msg = "☑️ " + new Date().toLocaleString()
                        + " :\r\n" + BluetoothUtilities.space + "Server is running and waiting for client to establish connection.\r\n";
                txtMessageHistory.append(msg);
                btnSend.setEnabled(false);
            }
        }
